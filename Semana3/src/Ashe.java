public class Ashe extends Champion implements AsheActionCallbacks {
    ...
    public Ashe(int id, String name, String role, String difficulty, String descrption) {
        super(id, name, role, difficulty, descrption);
    }
    ...
    public void crystalArrow(Screen s) {
        ...
        s.repaint();
        s.out(showMessage(), "Helvetica", 28, Colors.BlueHorizon);
        s.showImage("enchantedCristalArrow.gif");
        s.setBounds(200, 100, 1100, 900);
    }
}
